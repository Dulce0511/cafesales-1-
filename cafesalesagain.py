...
def _(cafesales_df, clean_date, convert_data_types, fill_missing_prices):
    cafeclean_df = convert_data_types(cafesales_df)
    cafeclean_df = clean_date(cafesales_df)
    cafeclean_df = fill_missing_prices(cafesales_df)
    cafeclean_df = fill_missing_payment_location(cafesales_df)
    cafeclean_df = arrange(cafesales_df)
    cafeclean_df
    return (cafeclean_df,)
